...
# python main.py ctdetSpotNetVid --val_intervals 1 --nbr_frames 9 --num_epochs 1 --exp_id 9FB --dataset uadetrac1on10_b --arch hourglassSpotNetVid --batch_size 1 --master_batch 4 --lr 2e-7 --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_1.pth  # /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_best.pth
...
# python test.py ctdetSpotNetVid --test --exp_id 15F --nbr_frames 15 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model  /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_1.pth


# python main.py ctdetSpotNetVid --val_intervals 1 --nbr_frames 15 --num_epochs 1 --exp_id 15F --dataset uadetrac1on10_b --arch hourglassSpotNetVid --batch_size 1 --master_batch 4 --lr 2e-7 --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_1.pth  # /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_best.pth
# python test.py ctdetSpotNetVid --test --exp_id 15F --nbr_frames 15 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_1.pth  # /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/15F/model_best.pth # /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/AblationTestfromDetrac3/model_best.pth
# python main.py ctdetSpotNetVid --val_intervals 1 --nbr_frames 17 --num_epochs 1 --exp_id 17F --dataset uadetrac1on10_b --arch hourglassSpotNetVid --batch_size 1 --master_batch 4 --lr 2e-7 --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_1.pth  # /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_best.pth
# python test.py ctdetSpotNetVid --test --exp_id 13F --nbr_frames 13 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/13F/model_best.pth

# python test.py ctdetSpotNetVid --test --exp_id 11F --nbr_frames 11 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/11F/model_best.pth
# python test.py ctdetSpotNetVid --test --exp_id 9F --nbr_frames 9 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/9F/model_best.pth
# python test.py ctdetSpotNetVid --test --exp_id 9FB --nbr_frames 9 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/9FB/model_best.pth
...
python main.py ctdetSpotNetVid --val_intervals 1 --nbr_frames 3 --num_epochs 1 --exp_id 3Prec --dataset uadetrac1on10_b --arch hourglassSpotNetVid --batch_size 1 --master_batch 4 --lr 2e-6 --load_model /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/fromDetrac/model_1.pth
python test.py ctdetSpotNetVid --test --exp_id 3Prec --nbr_frames 3 --dataset uadetrac1on10_b --arch hourglassSpotNetVid --keep_res --load_model  /store/dev/SpotNet2/exp/uadetrac1on10_b/ctdetSpotNetVid/3Prec/model_best.pth
